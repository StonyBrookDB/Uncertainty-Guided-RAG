...
THRESHOLD = 0.5
PATH = f"results-and-visualizations/ablation/{THRESHOLD}_rr_visualizations"
...
plt.tight_layout()
plt.savefig(f'{PATH}/answer_pie_charts.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/accuracy_by_subject.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/confidence_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/performance_across_splits.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/time_by_subject.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/uncertain_options_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(f'{PATH}/confidence_vs_similarity.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/source_pies.png')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/similarity_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/prob_distance.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{PATH}/id_frequency_distribution.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.show()
plt.savefig(f'{PATH}/different_ids_distribution.png', dpi=300, bbox_inches='tight')